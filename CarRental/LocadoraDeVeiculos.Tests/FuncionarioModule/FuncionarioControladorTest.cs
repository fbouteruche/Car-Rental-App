...
namespace CarRental.Tests.FuncionarioModule
{
    ...
    public class FuncionarioControladorTest
    {
        ...
        {
            //arrange
            funcionario = new Funcionario(0, "Name Teste removido", "954.746.736-04", "Endereco Funcionario", "4932518000", "teste@email.com", 001, "user acesso", "12345", new DateTime(2021, 01, 01), "Vendedor", 1000f, true);
        ...
        public void DeveEditarFuncionarioNoBanco()
        {
            //arrange
            funcionario = new Funcionario(0, "Name Teste", "954.746.736-04", "Endereco Funcionario", "4932518000", "teste@email.com", 001, "user acesso", "12345", new DateTime(2021, 01, 01), "Vendedor", 1000f, true);
            Funcionario funcionarioEditado = new Funcionario(0, "Name Teste2", "954.746.736-04", "Endereco Funcionario2", "4932518000", "teste2@email.com", 001, "user2 acesso", "12345", new DateTime(2021, 01, 01), "Vendedor2", 1000f, true);
        ...
        public void DeveSelecionarTodosFuncionarioNoBanco()
        {
            //arrange
            funcionario = new Funcionario(0, "Name Teste", "954.746.736-04", "Endereco Funcionario", "4932518000", "teste@email.com", 001, "user acesso", "12345", new DateTime(2021, 01, 01), "Vendedor", 1000f, true);
            funcionario2 = new Funcionario(0, "Name Teste", "954.746.736-04", "Endereco Funcionario", "4932518000", "teste@email.com", 001, "user acesso", "12345", new DateTime(2021, 01, 01), "Vendedor", 1000f, true);
