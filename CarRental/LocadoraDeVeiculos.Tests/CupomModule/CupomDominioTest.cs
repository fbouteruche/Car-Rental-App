...
namespace CarRental.Tests.CupomModule
{
    ...
    public class CupomDominioTest
    {
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "Nome Cupom", "NDD10TECH", 10, 2000, false, DateTime.Now.AddDays(10), parceiro);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "Nome Cupom", "NDD10TECH", 10, 2000, true, DateTime.Now.AddDays(10), parceiro);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "", "", 101, 0, false, DateTime.Now.AddDays(10), null);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "", "", 0, 0, true, DateTime.Now.AddDays(10), null);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "Nome Cupom", "NDD10TECH", 0, 2000, true, DateTime.Now.AddDays(10), parceiro);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "Nome Cupom", "NDD10TECH", 101, 2000, false, DateTime.Now.AddDays(10), parceiro);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "", "NDD10TECH", 10, 2000, true, DateTime.Now.AddDays(10), parceiro);
        ...
        {
            //arrange
            Coupon cupom = new Coupon(0, "Nome Cupom", "NDD10TECH", 10, 2000, true, DateTime.Now.AddDays(10), null);
